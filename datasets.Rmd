...
* `rate` if positive when `evid=1`, implements a zero-order infusion of duration `amt/rate`
...
* `ss` steady state indicator; use 1 to implement steady-state dosing; 0 otherwise
...
## Data sets, the parameter list and parameter updates
