...
Understanding the parameter update mechanism is very important for planning complicated simulations with `mrgsolve`.  Please review the information in \@ref(datasets) and in \@ref(topic-parameter-update).
